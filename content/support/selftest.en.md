...
If you use a *data saver*, *mobile booser* or similar extension or function that redirects the Internet traffic to another server, please turn it off for the test.
